...
class MainWindow(tk.Tk):
    ...
    def extraction_adjustment_frame(self):
        ...
        self.space_delimiter.grid(row=box_value, column=0, pady=3)
        ...
        self.tab_delimiter.grid(row=box_value, column=0, pady=5)
        ...
        self.txt_value.grid(row=box_value, column=1, pady=3)

        box_value += 1
        self.csv_value = tk.Radiobutton(
            box, text="csv", variable=self.extension_value, value=2
        )
        self.csv_value.grid(row=box_value, column=1, pady=5)
